...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm']) && $_POST['confirm'] === 'yes') {
    ...
    header("Location: listEmp.php?deleted=1");
    exit;
}
...
<div class="container mt-5">
    ...
    <div class="alert alert-warning">
        <p><i class="fa fa-exclamation-triangle"></i> <strong>Attention :</strong> Vous êtes sur le point de supprimer l'employé <strong><?= htmlspecialchars($employe['username']) ?></strong> (<?= htmlspecialchars($employe['email']) ?>).</p>
    </div>
