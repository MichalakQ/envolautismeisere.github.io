...
?>
<!--Page d'acccueil du site de rassemblement des commandes-->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Gestion des commandes transgourmet</title>
    ...
    <style>
        body {
                background-image: url('./assets/envolee.jpg'); /* chemin vers ton image */
...
<body>
    <h1><p class="dore">Commande pour transgourmet</h1></p>
    <?php include_once './assets/gestionMessage.php'; ?>
